...
// Uncommenting the next line should cause a TS compiler error (readonly):
...
// We want: name, age, contact:{email, extension}
type IntersectionEntry = Pick<Friend, "name" | "age"> & Pick<Colleague, "contact">;

function intersection(
    friends: Friend[],
    colleagues: Colleague[]
): IntersectionEntry[] {
    let result: IntersectionEntry[] = [];
